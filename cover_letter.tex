...
\setlength{\parindent}{10ex}
Currently pursuing a course on Artificial Intelligence and Algorithm Design,I find my research interest to be in these vast and dynamic subjects.As a starter,I have taken up various courses on Machine Learning by Andrew Ng on Coursera,edX,programming in python using PIP.I have undertaken a department project "“Stoppage Pattern Analysis of Public Bus GPS Traces in Developing Regions” under Dr. Subrata Nandi and Dr Sujoy Saha,NIT DGP where I have to implement and design algorithms for identification of bus stops in semi-urban/rural areas using machine learning.I feel that the academic environment suits me well and some research work as a part of your team would help me fully utilize my theoretical knowledge into practical application and also serve as a strong platform for my career.\par
